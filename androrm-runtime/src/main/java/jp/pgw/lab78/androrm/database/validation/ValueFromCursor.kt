...
import jp.pgw.lab78.androrm.database.validation.SqlDefaultValueValidator.dateTimeSpaceFormatter
import jp.pgw.lab78.androrm.database.validation.SqlDefaultValueValidator.validFormat
...
enum class SqlValueType(
    val type: KClass<*>, vararg val regex: String
) {
    /** Int / number */
    INT(Int::class, "^[+-]?\\d+$") {
        ...
        override fun toColumnValue(value: Any): Long = LONG.toColumnValue(value) as Long
    },
    ...
    FLOAT(Float::class, "^[+-]?\\d+(\\.\\d+)?$") {
        ...
        override fun toColumnValue(value: Any): Double = DOUBLE.toColumnValue(value) as Double
    },
    ...
    DOUBLE(Double::class, "^[+-]?\\d+(\\.\\d+)?$") {
        ...
        override fun toColumnValue(value: Any): Double =
            type.safeCast(value) as? Double ?: value.toString().toDouble()
    },
    ...
    NULL_VALUE(Any::class,  "^null$") {
        ...
        override fun getValueFromCursor(cursor: Cursor, columnIndex: Int) = "null"
